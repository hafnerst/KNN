...
public class CrossValidation {
	...
	public CrossValidation(ArrayList<double[]> negArrayList, ArrayList<double[]> posArrayList, ArrayList<double[]> testData, int _k){
	...
	public double runKNN() {
		...
		System.out.println("K: "+K+" Durchläufe: " + countAllIterations + " / Richtige: " + countRight + " / Prozent richtig: " + percent + " %");
		return percent;
	}
}
